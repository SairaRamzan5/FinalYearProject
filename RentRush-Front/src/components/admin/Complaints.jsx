...
// //   const [view, setView] = useState("showrooms"); // "showrooms" or "complaints"
...
// //                   className="cursor-pointer bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow p-6"
// //                 >
...
//         console.log("🔍 Resolution data check:", complaintsData.map(c => ({
//           id: c._id,
//           resolved: c.resolved,
...
//   // ✅ FIXED: Mark complaint as resolved with description
...
//         // ✅ Update complaints list with the resolved complaint data
...
//         <button
//           onClick={handleBackToShowrooms}
//           className="mb-4 px-4 py-2  text-black rounded-lg hover:bg-gray-700 transition-colors flex items-center"
//         >
//           ←
//         </button>
//       )}
...
//                 {/* ✅ NEW: Resolution Details Section */}

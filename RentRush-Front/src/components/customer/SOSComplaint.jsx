...
const SOSComplaint = () => {
  ...
  // 🚨 CONFIRM AND SUBMIT REPORT - Maintenance component jesa
  const handleConfirmReport = async () => {
    if (!selectedBooking || !customerName || !cnic) {
      Toast("⚠ User information not found. Please try again.", "error");
    ...
    try {
      ...
      // ✅ Success toast - Maintenance component jesa
      ...
      // ✅ Error toast - Maintenance component jesa
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {bookings.map((booking) => (
                  ...
                  >
                    {/* Card size reduced and Make Complaint button hidden */}
                    <div className="max-w-xs mx-auto scale-90 [&_.complaint-button]:hidden">
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
               ...
               className="px-4 py-2 rounded-lg bg-[#C17D3C] hover:bg-[#a5692f] transition-colors font-medium text-white"
              >
                 Send Report
              </button>
            </div>

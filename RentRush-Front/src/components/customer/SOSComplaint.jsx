...
//         customerName,
//         cnic,
//         bookingId: selectedBooking._id, // ✅ ADDED: Send booking ID
//         carId: reportData.carId, // ✅ ADDED: Send car ID
//         rentalDetails: {
//           carName: reportData.car.name,
//           plateNumber: reportData.car.plateNumber,
//           rentalStartDate: reportData.rental.start,
...
//               <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
//                 <p className="text-yellow-800 text-sm">
//                   <strong>⚠️ Warning:</strong> This is a serious action. Only report if the vehicle is actually stolen. 
...
import BookingCard from "./BookingCard.jsx";
import { FiX } from "react-icons/fi";
import Toast from "../Toast"; // ✅ Same Toast utility import

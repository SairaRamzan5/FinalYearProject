  ...
  const submitRating = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        alert(userRating ? "Rating updated successfully!" : "Thank you for your rating! Your feedback has been submitted.");
      } else {
      ...
      if (err.response?.status === 401) {
        ...
        setRatingError(err.response?.data?.message || "Something went wrong. Please try again.");
      }
    } finally {

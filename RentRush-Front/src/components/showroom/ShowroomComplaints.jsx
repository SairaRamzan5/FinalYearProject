...
// //   Download
// // } from "lucide-react";
// // import Toast from "../Toast"; // ✅ Import Toast utility
...
// //   // ✅ Mark complaint as resolved - WITH TOAST NOTIFICATION
...
//   // ✅ NEW: Handle resolution modal backdrop click
...
//   // ✅ UPDATED: Mark complaint as resolved - WITH DESCRIPTION
...
//       {/* ✅ NEW: Resolution Description Modal */}
//       {showResolutionModal && (
//         <div 
//           className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4"
...
function ShowroomComplaints() {
  ...
  const fetchShowroomComplaints = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        console.log("📋 Showroom complaints resolution data:", complaintsData.map(c => ({
          id: c._id,
          resolved: c.resolved,
  ...
  const viewComplaintDetails = (complaint) => {
    console.log("🔍 Opening details for complaint:", complaint._id);
    console.log("📝 Complaint resolution data:", {

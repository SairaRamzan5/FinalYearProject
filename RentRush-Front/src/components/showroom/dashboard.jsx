...
//   // Get showroom data from session storage with fallbacks
...
//               src={logoUrl}
//               alt="Showroom Logo"
//               className="h-20 w-22 rounded-[10px] border-2 border-gray-200 shadow-sm mr-2 object-cover"
//               onError={(e) => {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="relative flex items-center px-4 py-2 bg-red-100 text-red-700 border border-red-300 rounded-lg shadow-sm hover:bg-red-200 transition-all duration-200"
                  type="button"
                >

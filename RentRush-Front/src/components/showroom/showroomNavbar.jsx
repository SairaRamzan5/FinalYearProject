...
//         return `${Base_Url}${profileData.profilePicture}`;
//       }
//       if (profileData.profilePicture.startsWith('uploads/')) {
//         return `${Base_Url}/${profileData.profilePicture}`;
//       }
//       return `${Base_Url}/uploads/${profileData.profilePicture}`;
//     }
...
//       setLoading(true);
//       const response = await fetch(
//         `${Base_Url}/api/notifications/user/${showroomId}?unreadOnly=false&limit=10`
//       );
...
//     try {
//       const response = await fetch(
//         `${Base_Url}/api/notifications/read-all/${showroomId}`,
//         {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
...
//   // Updated dropdownItems with Profile added at the top
//   const dropdownItems = [
